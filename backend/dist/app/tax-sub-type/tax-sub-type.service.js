...
exports.TaxSubTypeService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const tax_sub_type_entity_1 = require("./entities/tax-sub-type.entity");
let TaxSubTypeService = class TaxSubTypeService {
    constructor(taxSubTypeRepo) {
        this.taxSubTypeRepo = taxSubTypeRepo;
    }
...
TaxSubTypeService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(tax_sub_type_entity_1.TaxSubType)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], TaxSubTypeService);
exports.TaxSubTypeService = TaxSubTypeService;
//# sourceMappingURL=tax-sub-type.service.js.map